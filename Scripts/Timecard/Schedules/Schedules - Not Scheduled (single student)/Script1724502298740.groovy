...
// click first student on the home screen
driver.findElements(By.xpath('//div[@id="studentsListContainer"]/child::div'))[0].click()

// jump to friday
driver.findElement(By.xpath('//*[@id="daysContainer"]/div[5]/button')).click()

// verify Not Scheduled
WebUI.verifyTextPresent("Not Scheduled", false)
