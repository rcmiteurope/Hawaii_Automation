...
// friday's schedule has no one scheduled
WebUI.navigateToUrl(GlobalVariable.timecard_url + "/login?cd=" + GlobalVariable.friday)
...
WebUI.verifyTextPresent("Nothing Scheduled For Friday", false)
