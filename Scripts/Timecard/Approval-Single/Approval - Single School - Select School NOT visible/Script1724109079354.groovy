...
// Select School page should not be displayed on single-school schedules
if (WebUI.verifyTextPresent("Select School", false, FailureHandling.OPTIONAL)) {
	
	// if Select School is displayed, throw an error
	KeywordUtil.markFailed('Select School page should not be displayed; all students are from the same school')
