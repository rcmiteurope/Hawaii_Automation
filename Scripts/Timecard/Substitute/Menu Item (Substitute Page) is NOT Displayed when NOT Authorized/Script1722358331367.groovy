...
CustomKeywords.'timecard.login'(GlobalVariable.valid_pin)
...
// element s/n/b present for 123450
WebUI.verifyElementNotPresent(findTestObject('Object Repository/HTA/a_Substitute Page'), 0)
