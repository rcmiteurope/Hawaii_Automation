...
WebElement dateOption = dropdown.findElement(By.xpath("//option[text()='Tomorrow']"))
dateOption.click()
...
String tomorrow = new SimpleDateFormat("MM/dd").format(cal.getTime())
...
for (WebElement cell : col3Cells) {
    ...
    Assert.assertEquals(
        mmddFromCell,
        tomorrow,
        "Expected tomorrow's date '" + tomorrow + "' but found: " + mmddFromCell
    )
}
