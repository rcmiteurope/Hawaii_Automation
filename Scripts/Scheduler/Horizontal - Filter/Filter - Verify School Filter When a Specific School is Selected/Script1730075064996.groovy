...
TestObject dropdownObj = new TestObject().addProperty('id', ConditionType.EQUALS, 'school_filter_select')
WebUI.waitForElementClickable(dropdownObj, 10)

WebElement dropdown = driver.findElement(By.id('school_filter_select'))
dropdown.click()

WebElement selectedOption = dropdown.findElement(By.xpath("//option[text()='Aina Haina']"))
...
for (WebElement div : divElements) {
	...
	Assert.assertTrue(divText.contains("Aina Haina"))
}
