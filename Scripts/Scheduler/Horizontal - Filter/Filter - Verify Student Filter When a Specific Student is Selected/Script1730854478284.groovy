...
TestObject dropdownObj = new TestObject().addProperty('id', ConditionType.EQUALS, 'student_filter_select')
WebUI.waitForElementClickable(dropdownObj, 10)

WebElement dropdown = driver.findElement(By.id('student_filter_select'))
dropdown.click()

WebElement selectedOption = driver.findElement(By.xpath("//option[contains(@value, '\"firstname\":\"Lincoln\"')]"))
selectedOption.click()

String columnXPath = "(//table[@id='horizontal-table'])[2]/tbody/tr/td[1]"
...
for (WebElement div : divElements) {
	...
	Assert.assertTrue(divText.contains("Avilla, Lincoln"))
}
