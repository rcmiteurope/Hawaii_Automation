...
TestObject searchOption = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id=\':ra:\']/button[3]/div')
...
List<WebElement> col4Cells = driver.findElements(By.xpath('//table[@id=\'vertical-table\']/tbody/tr/td[2]/span'))

for (WebElement cell : col4Cells) {
    String cellText = cell.getText().trim()
	WebUI.comment(cellText)
    Assert.assertTrue(cellText.contains('Abe, Tyler'))
}
