...
driver.manage().addCookie(new Cookie('user_email', GlobalVariable.sc_auth_token_jirome))
driver.manage().addCookie(new Cookie('user_name', GlobalVariable.sc_auth_token_jirome))
