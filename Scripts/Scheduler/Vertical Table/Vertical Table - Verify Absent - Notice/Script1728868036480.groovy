...
if (actualText == 'Student Absent - Notice') 
{
    ...
    WebUI.verifyElementText(new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="tr-main-13"]/td[5]/div'), 'Student Absent - Notice')
    ...
    WebUI.verifyElementText(new TestObject().addProperty("xpath", ConditionType.EQUALS, '//*[@id="tr-main-9"]/td[5]/div'), 'Student Absent - Notice')
