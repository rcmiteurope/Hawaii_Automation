...
WebElement dropdown = driver.findElement(By.xpath("//div[@id='filter-wrapper']/select[5]"))
dropdown.click()
...
List<String> expectedOptions = ['Add School', 'Add Student', 'Add Provider', 'Add Workorder', 'Save Bookmark'] 
