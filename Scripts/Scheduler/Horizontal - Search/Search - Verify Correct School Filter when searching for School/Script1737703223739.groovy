...
TestObject searchOption = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id=\':ra:\']/button[4]/div')

WebUI.click(searchOption)

WebUI.click(findTestObject('Object Repository/Search/Page_Scheduler/div_Search_css-19bb58m'))

WebUI.click(findTestObject('Object Repository/Search/Page_Scheduler/div_Aina Haina'))
