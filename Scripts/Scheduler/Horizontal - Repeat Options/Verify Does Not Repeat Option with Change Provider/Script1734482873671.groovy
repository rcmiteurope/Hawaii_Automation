...
TestObject selectedSched = new TestObject().addProperty("xpath", ConditionType.EQUALS, "(//table[@id='horizontal-table'])[2]//tbody//tr[4]//td[6]//div")
  
// Get the text of the element 
String elementText = WebUI.getText(selectedSched)
  
// Check if the text matches the expected value 
String expectedText = 'Aana, Leslie Ann' // Replace with your expected text
  
 if (elementText.contains(expectedText)) { 
    WebUI.comment("Text matches: " + elementText) 
} else {
