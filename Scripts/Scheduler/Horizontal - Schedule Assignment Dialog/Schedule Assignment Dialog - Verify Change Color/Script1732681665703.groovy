...
WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="hori-change-color"]'))
 
WebUI.click(findTestObject('Object Repository/ScheduleAssignmentDialog/Page_Scheduler/div_Foreground_w-7 h-7 rounded-lg border-2 _9f7500'))

WebUI.click(findTestObject('Object Repository/ScheduleAssignmentDialog/Page_Scheduler/div'))

WebUI.click(findTestObject('Object Repository/ScheduleAssignmentDialog/Page_Scheduler/div_Background_w-7 h-7 rounded-lg border-2 _41ce99'))

WebUI.click(findTestObject('Object Repository/ScheduleAssignmentDialog/Page_Scheduler/div_1_2_3'))
