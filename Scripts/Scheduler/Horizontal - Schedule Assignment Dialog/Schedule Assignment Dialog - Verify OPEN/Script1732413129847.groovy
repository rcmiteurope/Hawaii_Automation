...
WebUI.click(findTestObject('Object Repository/ScheduleAssignmentDialog/Page_Scheduler/div_Abad, Jose   0800-1300'))

WebUI.click(findTestObject('Object Repository/ScheduleAssignmentDialog/Page_Scheduler/button_OPEN'))

WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="sched-dialog-save"]'))

//WebUI.verifyElementText(findTestObject('Object Repository/ScheduleAssignmentDialog/Page_Scheduler/p_OPEN'), 'OPEN')
