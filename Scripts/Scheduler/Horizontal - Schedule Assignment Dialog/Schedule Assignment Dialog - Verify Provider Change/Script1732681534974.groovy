...
WebUI.click(findTestObject('Object Repository/ScheduleAssignmentDialog/Page_Scheduler/div_OPEN 0800-1415'))
...
WebUI.click(findTestObject('Object Repository/ScheduleAssignmentDialog/Page_Scheduler/div_Adam, Paula'))

WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="sched-dialog-save"]'))

WebUI.verifyElementText(findTestObject('Object Repository/ScheduleAssignmentDialog/Page_Scheduler/p_Adam, Paula'), 'Adam, Paula')
